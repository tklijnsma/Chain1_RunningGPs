...
scram b
cd ../../
cmsDriver.py $FRAGMENT_PY --fileout file:HIG-RunIIWinter15wmLHE-00035.root --mc --eventcontent LHE --datatier LHE --conditions MCRUN2_71_V1::All --step LHE --python_filename HIG-RunIIWinter15wmLHE-00035_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 3842 || exit $? ;
