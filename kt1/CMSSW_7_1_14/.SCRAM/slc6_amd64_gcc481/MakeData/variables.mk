...
CMSSW_BASE:=/afs/cern.ch/work/t/tklijnsm/Production/Chain1_RunningGPs/kt1/CMSSW_7_1_14
...
HERWIG_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/herwig/6.521-cms7
...
JIMMY_HEADERS_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/jimmy/4.2-cms7
...
CASCADE_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/cascade/2.2.04-cms7
...
DAS_CLIENT_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/cms/das-client/2.5.0-cms
...
SHERPA_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/sherpa/2.1.1-cms5
...
FASTJET_CONTRIB_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/fastjet-contrib/1.009-cms3
GEANT4CORE_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/geant4/10.00.p02
G4LIB:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/geant4/10.00.p02/lib
...
THEPEG_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/thepeg/1.9.2p1-cms
...
LHAPDF_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/lhapdf/5.9.1-cms3
...
export CCACHE_BASEDIR:=/afs/cern.ch/cms/slc6_amd64_gcc481/cms/cmssw/CMSSW_7_1_14
endif
ifeq ($(strip $(SCRAM_COMPILER)),llvm)
FC:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/gcc/4.8.1/bin/gfortran
endif
...
GEANT4STATIC_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/geant4/10.00.p02
...
GEANT4_PARFULLCMS:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/geant4-parfullcms/2014.01.27-cms3
...
PYTHIA8_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/pythia8/205-cms
...
CASCADE_HEADERS_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/cascade/2.2.04-cms7
...
HERWIGPP_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/herwigpp/2.7.1-cms5
...
TAUOLAPP_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/tauolapp/1.1.4-cms10
...
CORAL_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/cms/coral/CORAL_2_3_21-cms44
...
JIMMY_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/jimmy/4.2-cms7
CGAL_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/cgal/4.2-cms6
EVTGEN_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/evtgen/1.3.0-cms11
PY2SHIPY_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/py2-scipy/0.8.0-cms2
GIT_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/git/1.8.3.1-cms3
...
CHARYBDIS_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/charybdis/1.003-cms7
...
LOCALTOP:=/afs/cern.ch/work/t/tklijnsm/Production/Chain1_RunningGPs/kt1/CMSSW_7_1_14
SCRAM_TMP:=tmp
SCRAM_INIT_LOCALTOP:=/afs/cern.ch/work/t/tklijnsm/Production/Chain1_RunningGPs/kt1/CMSSW_7_1_14
SCRAM_BUILDFILE:=BuildFile
RELEASETOP:=/afs/cern.ch/cms/slc6_amd64_gcc481/cms/cmssw/CMSSW_7_1_14
SCRAM_INTlog:=logs
...
SCRAM_SOURCEDIR:=src
SCRAM_RTBOURNE_SET:=CMSSW:CMSSW_7_1_14:slc6_amd64_gcc481:V2_2_6_pre5:SRT_
SCRAM_CONFIGCHKSUM:=V05-04-02
SCRAM_LOOKUPDB_WRITE:=/afs/.cern.ch/cms
SCRAM_PROJECTVERSION:=CMSSW_7_1_14
